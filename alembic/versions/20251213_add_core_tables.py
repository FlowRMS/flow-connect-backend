...
def upgrade() -> None:
    _ = op.create_table(
            ...
            sa.Column("freight_discount_type", sa.Integer(), nullable=False, server_default="1"),
            ...
            sa.Column(
                "direct_commission_allowed", sa.Boolean(), nullable=False, server_default="true"
            ),
            sa.Column("created_at", postgresql.TIMESTAMP(timezone=False), nullable=False, server_default=sa.text("now()")),
            sa.Column("created_by_id", postgresql.UUID(as_uuid=True), nullable=True),
            sa.ForeignKeyConstraint(["created_by_id"], ["user.users.id"]),
    ...
    _ = op.create_table(
            ...
            sa.ForeignKeyConstraint(["inside_rep_id"], ["user.users.id"]),
    ...
    _ = op.create_table(
            ...
            sa.UniqueConstraint("factory_part_number", "factory_id", name="uix_factory_part_number_factory_id"),
        )
