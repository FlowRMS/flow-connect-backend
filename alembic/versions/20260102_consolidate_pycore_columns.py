...
def upgrade() -> None:
    ...
    op.add_column(
        "products",
        sa.Column("order_quantity", sa.Numeric(precision=15, scale=4), nullable=True),
        schema="pycore",
    )
    op.add_column(
        "products",
    ...
    op.add_column(
        "product_uoms",
        sa.Column("is_base_uom", sa.Boolean(), nullable=True),
        schema="pycore",
    )
    op.add_column(
        "product_uoms",
...
def downgrade() -> None:
    ...
    # Products
    op.drop_constraint(
        "fk_products_updated_by_id", "products", schema="pycore", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_products_created_by_id", "products", schema="pycore", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_products_product_category_id",
        "products",
    ...
    op.drop_constraint(
        "fk_products_factory_id", "products", schema="pycore", type_="foreignkey"
    )
