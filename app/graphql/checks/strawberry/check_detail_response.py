...
from app.graphql.invoices.strawberry.invoice_response import InvoiceLiteCheckResponse
...
class CheckDetailResponse(DTOMixin[CheckDetail]):
    ...
    @strawberry.field
    def invoice(self) -> InvoiceLiteCheckResponse | None:
        return InvoiceLiteCheckResponse.from_orm_model_optional(self._instance.invoice)
