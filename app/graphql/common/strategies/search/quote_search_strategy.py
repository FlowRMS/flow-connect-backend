...
from commons.db.v6.crm.quotes.quote import Quote
...
class QuoteSearchQueryBuilder(SearchQueryBuilder[Quote]):
    @override
...
class QuoteSearchStrategy(SearchQueryStrategy):
    def __init__(self) -> None:
        super().__init__()
        self.query_builder = QuoteSearchQueryBuilder(Quote, SourceType.QUOTE)
