...
class StatementBalanceRepository(
    BaseBalanceRepository[CommissionStatementBalance, CommissionStatementDetail]
):
    def __init__(self, context_wrapper: ContextWrapper, session: AsyncSession) -> None:
        super().__init__(context_wrapper, session, CommissionStatementBalance)

    @override
    def calculate_balance_from_details(
        self,
        details: Sequence[CommissionStatementDetail],
        ...
        balance = CommissionStatementBalance(
            quantity=quantity,
            subtotal=subtotal,
            total=total,
